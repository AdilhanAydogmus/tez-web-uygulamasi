...
async def tez_verisi_ile_segmentasyon():

    try:

        profil_df, cluster_ozet, kmeans, profile_scaler, plot_path, sil_score = kumeleme_pipeline(
        ...
        return {
            "message": "Tez verisi ile kümeleme tamamlandı.",
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Kümeleme işlemi sırasında hata oluştu: {str(e)}"
        )
